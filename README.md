...
Alameda learns the continuing changes of compute and I/O metrics from clusters, predicts future demands of pods and resource availability of nodes, and generate intelligent resource configuration recommendation. The prediction and recommendation generated by Alameda can faciliate predictive container and storage orchestation tasks, such as pod auto-scaling, scheduler, cluster auto-scaling, and persistent volume provisioning, etc.
