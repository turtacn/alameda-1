...
// Options defines the set of options supported by Alameda's component logging package.
type Options struct {
...
//
// Cobra is the command-line processor that Alameda uses. This command attaches
