...
func (in *AlamedaController) DeepCopyInto(out *AlamedaController) {
	*out = *in
	if in.Deployments != nil {
		...
		*out = make(map[NamespacedName]AlamedaDeployment, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlamedaDeployment) DeepCopyInto(out *AlamedaDeployment) {
	*out = *in
	if in.Pods != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlamedaDeployment.
func (in *AlamedaDeployment) DeepCopy() *AlamedaDeployment {
	if in == nil {
		return nil
	}
	out := new(AlamedaDeployment)
	in.DeepCopyInto(out)
	return out
}
