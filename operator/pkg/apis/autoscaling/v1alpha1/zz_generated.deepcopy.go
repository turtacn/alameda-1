...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlamedaUpdation) DeepCopyInto(out *AlamedaUpdation) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlamedaUpdation.
func (in *AlamedaUpdation) DeepCopy() *AlamedaUpdation {
	if in == nil {
		return nil
	}
	out := new(AlamedaUpdation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *AlamedaUpdation) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlamedaUpdationList) DeepCopyInto(out *AlamedaUpdationList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]AlamedaUpdation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlamedaUpdationList.
func (in *AlamedaUpdationList) DeepCopy() *AlamedaUpdationList {
	if in == nil {
		return nil
	}
	out := new(AlamedaUpdationList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *AlamedaUpdationList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlamedaUpdationSpec) DeepCopyInto(out *AlamedaUpdationSpec) {
	*out = *in
	in.AlamedaRecommendationSpec.DeepCopyInto(&out.AlamedaRecommendationSpec)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlamedaUpdationSpec.
func (in *AlamedaUpdationSpec) DeepCopy() *AlamedaUpdationSpec {
	if in == nil {
		return nil
	}
	out := new(AlamedaUpdationSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlamedaUpdationStatus) DeepCopyInto(out *AlamedaUpdationStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlamedaUpdationStatus.
func (in *AlamedaUpdationStatus) DeepCopy() *AlamedaUpdationStatus {
	if in == nil {
		return nil
	}
	out := new(AlamedaUpdationStatus)
	in.DeepCopyInto(out)
	return out
}
