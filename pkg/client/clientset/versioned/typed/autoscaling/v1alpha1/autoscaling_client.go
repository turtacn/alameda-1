...
import (
	...
	"github.com/containers-ai/alameda/pkg/client/clientset/versioned/scheme"
...
// AutoscalingV1alpha1Client is used to interact with features provided by the autoscaling.containers.ai group.
type AutoscalingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AutoscalingV1alpha1Client) AlamedaVPAs(namespace string) AlamedaVPAInterface {
	return newAlamedaVPAs(c, namespace)
}
