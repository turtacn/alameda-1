...
func init() {
	...
	reasonMap[ReasonMissingKeyReqBody] = "Key(%s) is not given in request body."
	...
	reasonMap[ReasonLicenseInvalidKeycode] = "Invalid keycode."
	reasonMap[ReasonLicenseInvalidContent] = "Invalid license file."
	reasonMap[ReasonLicenseInvalidSignature] = "Invalid signature."
	reasonMap[ReasonLicenseInvalidTool] = "Invalid tool."
	reasonMap[ReasonLicenseInvalidState] = "Invalid state."
	reasonMap[ReasonLicenseSIDMismatch] = "SID mismatch."
	reasonMap[ReasonLicenseDomainMismatch] = "Domain mismatch."
	reasonMap[ReasonLicenseVersionMismatch] = "Version mismatch."
	reasonMap[ReasonLicenseOEMVendorMismatch] = "OEM vendor mismatch."
	reasonMap[ReasonLicenseNoLicenseFile] = "No license file."
	reasonMap[ReasonLicenseKeycodeNotFound] = "Keycode(%s) is not found."
	reasonMap[ReasonLicenseKeycodeAlreadyApplied] = "Keycode(%s) is already applied."
	reasonMap[ReasonLicenseIncorrectPadding] = "Incorrect padding."
	...
	reasonMap[ReasonLicenseInvalidSystemTime] = "Invalid system time."
