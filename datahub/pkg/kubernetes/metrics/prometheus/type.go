...
func transformResultsPrometheusLabelIntoLabelSelectorKeyByMetricType(q metrics.QueryResponse) (metrics.QueryResponse, error) {
	...
	case metrics.MetricTypeContainerCPUUsageSecondsPercentage:
		labelsInPrometheus = containerCPUUsageSecondsPercentage.LabelMapper.PrometheusLabels
		labelSelectorKeys = containerCPUUsageSecondsPercentage.LabelMapper.LabelSelectorKeys
