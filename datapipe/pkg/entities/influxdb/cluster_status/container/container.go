...
//raw data
var (
	ContainerDatabaseName    = "alameda_cluster_status"
	ContainerMeasurementName = "container"
	ContainerColumns         = []string{
		//tags
		ContainerNamespace, ContainerPodName,
		ContainerAlamedaScalerNamespace, ContainerAlamedaScalerName,
		ContainerNodeName, ContainerName, ContainerAppName, ContainerAppPartOf,
	...
	ContainerColumnsTypes = make([]commonAPI.ColumnType, 0)
	ContainerDataTypes    = make([]commonAPI.DataType, 0)

	ContainerColIndexMap = map[string]int{}
)

func init() {
	for index, value := range ContainerColumns {
		if index < len(ContainerTags)-1 {
			ContainerColumnsTypes = append(ContainerColumnsTypes, commonAPI.ColumnType_COLUMNTYPE_TAG)
		} else {
			ContainerColumnsTypes = append(ContainerColumnsTypes, commonAPI.ColumnType_COLUMNTYPE_FIELD)
		}

		ContainerDataTypes = append(ContainerDataTypes, commonAPI.DataType_DATATYPE_STRING)
		ContainerColIndexMap[value] = index
	}

	ContainerDataTypes[ContainerColIndexMap[ContainerStatusRunningStartedAt]] = commonAPI.DataType_DATATYPE_INT64
	ContainerDataTypes[ContainerColIndexMap[ContainerStatusTerminatedExitCode]] = commonAPI.DataType_DATATYPE_INT32

	ContainerDataTypes[ContainerColIndexMap[ContainerStatusTerminatedStartedAt]] = commonAPI.DataType_DATATYPE_INT64
	ContainerDataTypes[ContainerColIndexMap[ContainerStatusTerminatedFinishedAt]] = commonAPI.DataType_DATATYPE_INT32

	ContainerDataTypes[ContainerColIndexMap[ContainerLastTerminationStatusRunningStartedAt]] = commonAPI.DataType_DATATYPE_INT64
	ContainerDataTypes[ContainerColIndexMap[ContainerLastTerminationStatusTerminatedExitCode]] = commonAPI.DataType_DATATYPE_INT64

	ContainerDataTypes[ContainerColIndexMap[ContainerLastTerminationStatusTerminatedStartedAt]] = commonAPI.DataType_DATATYPE_INT64
	ContainerDataTypes[ContainerColIndexMap[ContainerLastTerminationStatusTerminatedFinishedAt]] = commonAPI.DataType_DATATYPE_INT64

	ContainerDataTypes[ContainerColIndexMap[ContainerRestartCount]] = commonAPI.DataType_DATATYPE_INT32
	ContainerDataTypes[ContainerColIndexMap[ContainerResourceRequestCPU]] = commonAPI.DataType_DATATYPE_FLOAT32
	ContainerDataTypes[ContainerColIndexMap[ContainerResourceRequestMemory]] = commonAPI.DataType_DATATYPE_INT64
	ContainerDataTypes[ContainerColIndexMap[ContainerResourceLimitCPU]] = commonAPI.DataType_DATATYPE_FLOAT32
	ContainerDataTypes[ContainerColIndexMap[ContainerResourceLimitMemory]] = commonAPI.DataType_DATATYPE_INT64

	ContainerDataTypes[ContainerColIndexMap[ContainerPodCreateTime]] = commonAPI.DataType_DATATYPE_INT64
	ContainerDataTypes[ContainerColIndexMap[ContainerTpoControllerReplicas]] = commonAPI.DataType_DATATYPE_INT32

	ContainerDataTypes[ContainerColIndexMap[ContainerEnableHPA]] = commonAPI.DataType_DATATYPE_BOOL
	ContainerDataTypes[ContainerColIndexMap[ContainerEnableVPA]] = commonAPI.DataType_DATATYPE_BOOL
}
