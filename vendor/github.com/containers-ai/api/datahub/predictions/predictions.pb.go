...
func (*ContainerPrediction) Descriptor() ([]byte, []int) {
	return fileDescriptor_2248412311050739, []int{0}
}
...
func (*PodPrediction) Descriptor() ([]byte, []int) {
	return fileDescriptor_2248412311050739, []int{1}
}
...
func (*NodePrediction) Descriptor() ([]byte, []int) {
	return fileDescriptor_2248412311050739, []int{2}
}
...
func init() {
	proto.RegisterFile("datahub/predictions/predictions.proto", fileDescriptor_2248412311050739)
}

var fileDescriptor_2248412311050739 = []byte{
