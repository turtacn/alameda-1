...
func (*ContainerMetric) Descriptor() ([]byte, []int) {
	return fileDescriptor_metrics_0fe83b27a3082009, []int{0}
}
...
func (*PodMetric) Descriptor() ([]byte, []int) {
	return fileDescriptor_metrics_0fe83b27a3082009, []int{1}
}
...
func (*NodeMetric) Descriptor() ([]byte, []int) {
	return fileDescriptor_metrics_0fe83b27a3082009, []int{2}
}
...
func init() {
	proto.RegisterFile("datahub/metrics/metrics.proto", fileDescriptor_metrics_0fe83b27a3082009)
}

var fileDescriptor_metrics_0fe83b27a3082009 = []byte{
