...
_READRAWDATAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='queries', full_name='containersai.datahub.rawdata.ReadRawdataRequest.queries', index=0,
...
_WRITERAWDATAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='rawdata', full_name='containersai.datahub.rawdata.WriteRawdataRequest.rawdata', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
