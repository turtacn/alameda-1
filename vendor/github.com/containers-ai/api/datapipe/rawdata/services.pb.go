...
func (*ReadRawdataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7978735a6dd8a91c, []int{0}
}
...
func (*ReadRawdataResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7978735a6dd8a91c, []int{1}
}
...
func (*WriteRawdataRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7978735a6dd8a91c, []int{2}
}
...
func init() { proto.RegisterFile("datapipe/rawdata/services.proto", fileDescriptor_7978735a6dd8a91c) }

var fileDescriptor_7978735a6dd8a91c = []byte{
