...
_POD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='alameda_scaler_resources', full_name='containers_ai.alameda.v1alpha1.datahub.Pod.alameda_scaler_resources', index=15,
...
_NODE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='provider', full_name='containers_ai.alameda.v1alpha1.datahub.Node.provider', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PROVIDER = _descriptor.Descriptor(
  name='Provider',
  full_name='containers_ai.alameda.v1alpha1.datahub.Provider',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='provider', full_name='containers_ai.alameda.v1alpha1.datahub.Provider.provider', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instance_type', full_name='containers_ai.alameda.v1alpha1.datahub.Provider.instance_type', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='region', full_name='containers_ai.alameda.v1alpha1.datahub.Provider.region', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='zone', full_name='containers_ai.alameda.v1alpha1.datahub.Provider.zone', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='os', full_name='containers_ai.alameda.v1alpha1.datahub.Provider.os', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='role', full_name='containers_ai.alameda.v1alpha1.datahub.Provider.role', index=5,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instance_id', full_name='containers_ai.alameda.v1alpha1.datahub.Provider.instance_id', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='storage_size', full_name='containers_ai.alameda.v1alpha1.datahub.Provider.storage_size', index=7,
...
_POD.fields_by_name['alameda_scaler_resources'].message_type = alameda__api_dot_v1alpha1_dot_datahub_dot_metric__pb2._RESOURCEREQUIREMENTS
...
_NODE.fields_by_name['provider'].message_type = _PROVIDER
...
Provider = _reflection.GeneratedProtocolMessageType('Provider', (_message.Message,), {
  ...
  '__module__' : 'alameda_api.v1alpha1.datahub.resource_pb2'
  # @@protoc_insertion_point(class_scope:containers_ai.alameda.v1alpha1.datahub.Provider)
  })
