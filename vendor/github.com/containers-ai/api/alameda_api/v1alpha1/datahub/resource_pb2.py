...
_CONTAINER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='limit_resource_recommendation', full_name='containers_ai.alameda.v1alpha1.datahub.Container.limit_resource_recommendation', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='request_resource_recommendation', full_name='containers_ai.alameda.v1alpha1.datahub.Container.request_resource_recommendation', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='initial_limit_resource_recommendation', full_name='containers_ai.alameda.v1alpha1.datahub.Container.initial_limit_resource_recommendation', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='initial_request_resource_recommendation', full_name='containers_ai.alameda.v1alpha1.datahub.Container.initial_request_resource_recommendation', index=6,
...
_CONTAINER.fields_by_name['limit_resource_recommendation'].message_type = alameda__api_dot_v1alpha1_dot_datahub_dot_metric__pb2._METRICDATA
