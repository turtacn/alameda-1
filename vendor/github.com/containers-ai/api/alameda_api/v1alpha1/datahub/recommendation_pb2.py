...
_CONTROLLERRECOMMENDEDSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='containers_ai.alameda.v1alpha1.datahub.ControllerRecommendedSpec.create_time', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='current_cpu_requests', full_name='containers_ai.alameda.v1alpha1.datahub.ControllerRecommendedSpec.current_cpu_requests', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='current_mem_requests', full_name='containers_ai.alameda.v1alpha1.datahub.ControllerRecommendedSpec.current_mem_requests', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='current_cpu_limits', full_name='containers_ai.alameda.v1alpha1.datahub.ControllerRecommendedSpec.current_cpu_limits', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='current_mem_limits', full_name='containers_ai.alameda.v1alpha1.datahub.ControllerRecommendedSpec.current_mem_limits', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='desired_cpu_limits', full_name='containers_ai.alameda.v1alpha1.datahub.ControllerRecommendedSpec.desired_cpu_limits', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='desired_mem_limits', full_name='containers_ai.alameda.v1alpha1.datahub.ControllerRecommendedSpec.desired_mem_limits', index=10,
