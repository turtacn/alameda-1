...
_QUERYCONDITION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='selects', full_name='containersai.common.QueryCondition.selects', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='groups', full_name='containersai.common.QueryCondition.groups', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='limit', full_name='containersai.common.QueryCondition.limit', index=4,
...
ReadRawdata = _reflection.GeneratedProtocolMessageType('ReadRawdata', (_message.Message,), dict(
...
WriteRawdata = _reflection.GeneratedProtocolMessageType('WriteRawdata', (_message.Message,), dict(
