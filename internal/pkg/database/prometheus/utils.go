...
func oneToOneMultiply(entity1, entity2 Entity, opts ...operateOption) (Entity, error) {
	...
	entity = Entity{
		...
		Values: make([]UnixTimeWithSampleValue, len(entity1.Values)),
	}
	...
	for i, vector1Value := range entity1.Values {
		...
		entity.Values[i] = UnixTimeWithSampleValue{
