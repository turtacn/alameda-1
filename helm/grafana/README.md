...
And the additional dashboards are:
- ./dashboards/clusterHealth.json  
  This dashboard is intended to show current cluster status that are releated to the cluster health and cost.
- ./dashboards/prediction.json  
  This dashboard is intended to show the Alameda prediction and recommendations.
